...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            @can('create-role')
                <a href="{{ route('roles.create') }}" class="btn btn-success btn-sm my-2"><i class="bi
                bi-plus-circle"></i> Add New Role</a>
            @endcan
                                ...
                                @if ($role->name!='Super Admin')
                                    ...
                                    @can('delete-role')
                                        @if ($role->name!=Auth::user()->hasRole($role->name))
                                            ...
                                            confirm('Do you want to delete this role?');"><i class="bi bi-trash"></i>
                                                Delete
                                            </button>
                                        @endif
                                    @endcan
